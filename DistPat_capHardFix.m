...
%   capacity is a number reppresenting the fraction of the initial patients
%   the HCP is willing to take on in addition to his starting number. 10%
%   for example implies he will take 10% of his average number of patients
%   in addition to his mean number.
